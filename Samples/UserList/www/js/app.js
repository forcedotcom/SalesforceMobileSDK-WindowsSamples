    ...
    var authenticateUser = function (successHandler, errorHandler) {
        ...
        oauthPlugin.getAuthCredentials(
            ...
            function (creds) {
                ...
                var forceClient = new forcetk.Client(credentials.ClientId, credentials.LoginUrl);
                forceClient.setSessionToken(credentials.AccessToken, "v34.0", credentials.InstanceUrl);
